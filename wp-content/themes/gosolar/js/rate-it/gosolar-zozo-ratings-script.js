...
jQuery(document).ready(function( $ ){
	...
	//Init vars
	var ajaxRequestUrl 		= GoSolarItemRatingsVars.ajaxUrl;
	var nonceValue			= GoSolarItemRatingsVars.ajaxNonce;
	var rateUpdateAction	= GoSolarItemRatingsVars.rateUpdateAction;
	var pluginConfigOptions	= GoSolarItemRatingsVars.pluginConfigOptions;
	var ajaxUpdateErrorText	= GoSolarItemRatingsVars.ajaxRateUpdateErrorText;
