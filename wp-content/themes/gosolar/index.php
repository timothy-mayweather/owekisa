...
$data_attr = '';
$original_layout = '';
$original_layout = gosolar_get_theme_option( 'zozo_blog_type' );
$grid_columns = gosolar_get_theme_option( 'zozo_blog_grid_columns' );
$column_width = '';
$display_mode = '';
// Grid Style
			...
			<div class="zozo-row row">
				<div id="primary" class="content-area <?php gosolar_primary_content_classes(); ?>">
					<div id="content" class="site-content">	
						...
						if( gosolar_get_theme_option( 'zozo_show_blog_featured_slider' ) == 1 && gosolar_get_theme_option( 'zozo_featured_slider_type' ) == 'above_content' ) {
