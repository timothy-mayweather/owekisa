							...
							<div id="services-content-wrap" class="services-single clearfix">										
								<div <?php post_class(); ?> id="services-<?php the_ID(); ?>">
									<?php if( $zozo_services_gallery != '' ) {
										...
										$gallery_attr = '';
										if( gosolar_get_theme_option( 'zozo_service_citems' ) != '' ) {
											$gallery_attr .= ' data-items=' . gosolar_get_theme_option( 'zozo_service_citems' ) . ' ';
										}
										
										if( gosolar_get_theme_option( 'zozo_service_citems_scroll' ) != '' ) {
											$gallery_attr .= ' data-slideby=' . gosolar_get_theme_option( 'zozo_service_citems_scroll' ) . ' ';
										}
										
										if( gosolar_get_theme_option( 'zozo_service_ctablet' ) != '' ) {
											$gallery_attr .= ' data-items-tablet=' . gosolar_get_theme_option( 'zozo_service_ctablet' ) . ' ';
										}
										
										if( gosolar_get_theme_option( 'zozo_service_cmobile_land' ) != '' ) {
											$gallery_attr .= ' data-items-mobile-landscape=' . gosolar_get_theme_option( 'zozo_service_cmobile_land' ) . ' ';
										}
										
										if( gosolar_get_theme_option( 'zozo_service_cmobile' ) != '' ) {
											$gallery_attr .= ' data-items-mobile-portrait=' . gosolar_get_theme_option( 'zozo_service_cmobile' ) . ' ';
										}
										
										if( gosolar_get_theme_option( 'zozo_service_cautoplay' ) == 1 ) {
											$gallery_attr .= ' data-autoplay=true ';
										} else {
											$gallery_attr .= ' data-autoplay=false ';
										}
										
										if( gosolar_get_theme_option( 'zozo_service_ctimeout' ) != '' ) {
											$gallery_attr .= ' data-autoplay-timeout=' . gosolar_get_theme_option( 'zozo_service_ctimeout' ) . ' ';
										}
										
										if( gosolar_get_theme_option( 'zozo_service_cloop' ) == 1 ) {
											$gallery_attr .= ' data-loop=true ';
										} else {
											$gallery_attr .= ' data-loop=false ';
										}
										
										if( gosolar_get_theme_option( 'zozo_service_cmargin' ) != '' ) {
											$gallery_attr .= ' data-margin=' . gosolar_get_theme_option( 'zozo_service_cmargin' ) . ' ';
										}
										
										if( gosolar_get_theme_option( 'zozo_service_cpagination' ) == 1 ) {
											$gallery_attr .= ' data-pagination=true ';
										} else {
											$gallery_attr .= ' data-pagination=false ';
										}
										
										if( gosolar_get_theme_option( 'zozo_service_cnavigation' ) == 1 ) {
