...
jQuery(document).ready(function($) {
    ...
    var zozos = {
    	...
    	{			
    		...
    		$('.zozo-cinput', form).on('change', function() {
    			zozos.cLoadVals();
    		});
	...
	// Icon Selection
    $('.iconpicker i').on('click', function( event ) {
    ...
    $('#zozo-sc-form-table .zozo-insert').on('click', function( event ) {
