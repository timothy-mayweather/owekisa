 ...
 class TweetPHP {
    ...
    public function  __construct ($options = array()) {
      ...
      if ($this->options['enable_cache']) {
        ...
        $this->cache_file = $this->options['cache_dir'] . 'twitter-'. $this->options['twitter_screen_name'] .'.txt';
        $this->cache_file_raw = $this->options['cache_dir'] . 'twitter-array-'. $this->options['twitter_screen_name'] .'.txt';
